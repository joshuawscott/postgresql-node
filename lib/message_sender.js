...
exports.close = function (type, name) {
  var messageLength = 6 + Buffer.byteLength(name), // length octets
...
exports.copyData = function(data) {
  var messageLength = 4 + Buffer.byteLength(data),
      buf = new Buffer(messageLength + 1);
  buf.write('d', 0);
  buf.writeInt32BE(messageLength, 1);
  buf.write(data, 5);
...
// String - 'options' [optional, deprecated] NOT IMPLEMENTED
// String - command-line options for backend [optional, deprecated] NOT IMPLEMENTED
