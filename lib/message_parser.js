...
var copyData = function copyData(messageObj) {
  messageObj.copyData = messageObj.data.toString('utf-8');
  return messageObj;
};
...
var functionCallResponse = function functionCallResponse(messageObj) {
  errRaise();
};
